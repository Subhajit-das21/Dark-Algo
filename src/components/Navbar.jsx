    ...
    return (
        <header className="flex justify-between items-center px-8 mx-4 mt-4 h-[64px] rounded-2xl glass-strong z-50">
            ...
            <div className="flex items-center gap-6">
                ...
                <a href="https://github.com/Subhajit-das21/Dark-Algo" target="_blank" rel="noopener noreferrer" className="neon-text-blue text-sm font-semibold hover:underline flex items-center gap-2">
